...
const Statistics = () => {
  ...
  return (
    <>
      <header className="text-3xl center font-bold my-8">
        Experience Statistical Analyzer
      </header>
      <div className="bg-black min-h-screen flex items-center justify-center">
        <div className="bg-gray-500 w-full max-w-md rounded-lg shadow-md p-8">
          ...
          <button
            ...
            className="bg-green-500 text-white px-4 py-2 rounded-full mb-2"
          >{`Green (${option1Votes} votes)`}</button>
          ...
          >{`Blue (${option2Votes} votes)`}</button>
          <div className="flex items-center mb-2">
          ...
          <button
            ...
            className="bg-red-500 text-white px-4 py-2 rounded-full mb-2"
          >{`Red (${option3Votes} votes)`}</button>
          <div className="flex items-center mb-2">
          ...
          >{`Purple (${option4Votes} votes)`}</button>
          <div className="flex items-center mb-2">

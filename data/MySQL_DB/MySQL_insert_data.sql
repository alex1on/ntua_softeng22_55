...
INSERT INTO Questionnaire (QuestionnaireTitle, UserID)
VALUES ("Manos' Questionnaire", 1),
    ("pGiad's Questionnaire", 2),
    ("Alex's Questionnaire", 3),
    ("Velalo's Questionnaire", 4),
    ("Skatz's Questionnaire", 5);
-- Insert Question data
INSERT INTO Question (QText, Q_Required, Q_Type, QuestionnaireID)
VALUES (
...
INSERT INTO Q_Option (OptText, NextQID, QuestionID, QuestionnaireID)
VALUES ("chess", 2, 1, 1),
    ("basketball", 2, 1, 1),
    ("football", 2, 1, 1),
    ("18", 3, 2, 1),
